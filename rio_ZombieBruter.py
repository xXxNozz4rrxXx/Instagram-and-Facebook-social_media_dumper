...
try:
	...
	print W + ' '
	print ('[RioInstagram-Bruter]').center(44)
	print ' '
	print "[RioInstagram-Bruter] [!] Can't import module 'requests'\n"
	sys.exit()
####################################################################
...
def baliho():
	try:
		...
		print (W + '     [' + G +'[RioInstagram-Bruter] Facebook Information'+ W + ']')
		print ' '
####################################################################
#		    Print In terminal
def show_program():
...
def get(data):
	print '[RioInstagram-Bruter] ---> [*] Generate access token '
	...
	try:
		...
		b.close()
		print '[RioInstagram-Bruter] --->[*] successfully generate access token'
		print '[RioInstagram-Bruter] --->[*] Your access token is stored in cookie/token.log'
		exit()
	except KeyError:
		print '[RioInstagram-Bruter] --->[!] Failed to generate access token'
		print '[RioInstagram-Bruter] --->[!] Check your connection / email or password'
		os.remove('cookie/token.log')
		main()
	except requests.exceptions.ConnectionError:
		print '[RioInstagram-Bruter] --->[!] Failed to generate access token'
		print '[RioInstagram-Bruter] --->[!] Connection error !!!'
		os.remove('cookie/token.log')
		main()
def id():
	print '[RioInstagram-Bruter] ---> [*] login to your facebook account         ';id = raw_input('[RioInstagram-Bruter] ---> [?] Username : ');pwd = getpass.getpass('[RioInstagram-Bruter] --->[?] Password : ');API_SECRET = '62f8ce9f74b12f84c123cc23437a4a32';data = {"api_key":"882a8490361da98702bf97a021ddc14d","credentials_type":"[RioInstagram-Bruter] ---> [*] password","[RioInstagram-Bruter] ---> [*] email":id,"format":"JSON", "[RioInstagram-Bruter] ---> [*] generate_machine_id":"1","generate_session_cookies":"1","locale":"en_US","method":"auth.login","password":pwd,"return_ssl_resources":"0","v":"1.0"};sig = 'api_key=882a8490361da98702bf97a021ddc14dcredentials_type=passwordemail='+id+'format=JSONgenerate_machine_id=1generate_session_cookies=1locale=en_USmethod=auth.loginpassword='+pwd+'return_ssl_resources=0v=1.0'+API_SECRET
	x = hashlib.new('md5')
        x.update(sig)
...
def albums(posts):
	...
	try:
		...
		bot()
######################################################################################################################
#			    Rio Instagram Boting 
  			   # FUCK EVERY INSTAGRAM ACCOUNT POUTANES!!!!#
  ...
  try:
	...
	if cek.lower() == 'get_data':
		if len(jml) == 0:
			...
			print '[RioInstagram-Bruter] ----> [*] You have retrieved %s friends data'%(len(jml))
			main()
	elif cek.lower() == 'get_info':
		print '\n'+'[RioInstagram-Bruter] ----> [*] Information Gathering [*]'.center(44) + '\n'
		search()
	elif cek.lower() == 'bot':
		menu_bot()
		bot()
		...
		try:
			...
			print '[RioInstagram-Bruter] ----> [*] Your access token !!\n\n' + o + '\n'
			main()
		except IOError:
			print '[RioInstagram-Bruter] ----> [!] failed to open cookie/token.log'
			print "[RioInstagram-Bruter] ----> [!] type 'token' to generate access token"
			main()
		...
		try:
			open('cookie/token.log')
			print '[RioInstagram-Bruter] ----> [!] an access token already exists'
			cek = raw_input('[?] Are you sure you want to continue [Y/N] ')
			if cek.lower() != 'y':
				print '[RioInstagram-Bruter] ----> [*] Canceling '
				bot()
		except IOError:
			pass

		print '\n' + '[*] Generate Access token facebook [*]'.center(44) + '\n'
		print '[RioInstagram-Bruter] ----> [Warn] please turn off your VPN before using this feature !!!'
		id()
...
'''
		a = raw_input("[RioInstagram-Bruter] ----> [!] type 'delete' to continue : ")
		if a.lower() == 'delete':
			try:
				os.system('rm -rf cookie/token.log')
				print '[RioInstagram-Bruter] ----> [*] Success delete cookie/token.log'
				main()
			except OSError:
				print '[RioInstagram-Bruter] ----> [*] failed to delete cookie/token.log'
				main()
		else:
			print '[RioInstagram-Bruter] ----> [*] failed to delete cookie/token.log'
			main()
		...
		print "[RioInstagram-Bruter] ----> [!] Exiting Program"
		sys.exit()
	elif cek.lower() == 'help':
		info_ga()
		main()
...
def search():
	...
	if len(jml) == 0:
                print "[RioInstagram-Bruter] ----> [!] no friend data in the database"
                print '[RioInstagram-Bruter] ----> [!] type "get_data" to collect friends data'
                main()
        else:
                pass
...
def info(target):
        ...
        print '[RioInstagram-Bruter] ----> [*] Searching'
	for i in a['data']:
